...
export default function LeadershipPage() {
  ...
  const currentModule = modules[2]; // Strategic Thinking

  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-teal-100 dark:from-black dark:via-black dark:to-black">
          ...
          >
            <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 border border-white/20 shadow-2xl">
              ...
              <p className="text-xl md:text-2xl mb-8 text-gray-700 dark:text-gray-300">
                Build essential leadership and management skills for career success
              </p>
              ...
              <div className="w-full bg-gray-200 rounded-full h-3 mb-4">
                <div className="bg-gradient-to-r from-emerald-500 to-teal-500 h-3 rounded-full" style={{ width: '52%' }}></div>
              </div>
              <p className="text-sm text-muted-foreground">52% Complete</p>
            </div>
          </motion.div>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <Tabs defaultValue="overview" className="space-y-6">
              <TabsList className="grid w-full grid-cols-3 bg-gradient-to-r from-emerald-500 to-teal-500">
                ...
                <Card className="backdrop-blur-xl bg-white/20 dark:bg-gray-900/20 border-white/30 dark:border-gray-700/30 shadow-xl">
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-muted-foreground leading-relaxed">
                      Develop essential leadership skills that will set you apart in your career. This comprehensive course 
                      covers communication, team building, strategic thinking, conflict resolution, and change management. 
                      Perfect for aspiring leaders and managers.
                    </p>
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <ul className="space-y-1 text-sm text-muted-foreground">
                          <li>• Basic work experience</li>
                          <li>• Willingness to learn</li>
                          <li>• No prior leadership experience required</li>
                        </ul>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent>
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        <h4 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Leadership Expert</h4>
                        <p className="text-muted-foreground mb-3">
                          Senior Leadership Coach with 15+ years of experience in executive development and team management. 
                          Former VP at Fortune 500 companies, certified in organizational psychology.
                        </p>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4 text-center">
                  ...
                  <div className="p-3 bg-teal-50 dark:bg-teal-950/20 rounded-lg">
                    <div className="text-2xl font-bold text-teal-600">2/6</div>
